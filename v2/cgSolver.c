...
int main() {
    ...
    if (aloca_matrizes(&A, &ASP, &D, &L, &U, &M, n, k) != 0) {
    ...
    LIKWID_MARKER_START("v2-residuo");
    residuo = calcResiduoSL(A, b, x, n, k, &tempo_residuo);
    LIKWID_MARKER_STOP("v2-residuo");
